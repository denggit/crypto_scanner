...
from strategies.strategy_6_vcb_v2.methods.monitor import Strategy6Monitor
...
def get_user_input(default_config: dict = None) -> dict:
    """获取用户输入参数，使用配置文件的默认值"""
    from strategies.strategy_6_vcb_v2.shared_config import get_user_input as shared_get_user_input
...
def main():
    ...
    # 打印最终使用的参数
    from strategies.strategy_6_vcb_v2.shared_config import print_final_config
