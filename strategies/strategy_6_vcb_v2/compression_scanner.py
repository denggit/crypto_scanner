...
from strategies.strategy_6_vcb_v2.strategy_6 import VCBStrategy, CompressionEvent
                ...
                for future in concurrent.futures.as_completed(future_to_symbol):
                    ...
                    try:
                        ...
                        if compression:
                            ...
                            logger.info(f"✅ 发现压缩: {symbol} (ATR比率={compression.atr_ratio:.4f}, 压缩评分={compression.compression_score:.1f})")
                        completed += 1
    ...
    def _get_symbols_to_scan(self) -> List[str]:
        ...
        try:
            ...
            if self.only_major_coins:
                from strategies.strategy_6_vcb_v2.methods.position_manager import MAJOR_COINS
                filtered_symbols = []
                for symbol in symbols:
